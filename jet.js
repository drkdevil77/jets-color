var doodle = (function() {
    ...
    var getRandomFormation = function(stage) {
        ...
        // Updated colors: left = green, middle = red, right = green
        formation.addPlane(0, 0, "0, 200, 0");      // Left jet - Green
        formation.addPlane(50, -50, "255, 0, 0");   // Middle jet - Red
        formation.addPlane(100, 0, "0, 200, 0");    // Right jet - Green
